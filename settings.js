...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=6ccGETTA#XLfEqOO32SiHgLfcfL4UI6QAE3kmXdh3wvQNA-EVW5I' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || '|🍃|𝖕𝖆_𝖓_𝖉𝖆🥹💗' ,
COMMAND_TYPE: process.env.COMMAND_TYPE || 'button' ,
LOGO: process.env.LOGO || `https://telegra.ph/file/24c7ccf29cb1f6cb7626a.jpg` ,
